...
export const Hero = () => {
  ...
  return (
    <>
          ...
          >
            ...
            <div className="max-w-7xl mx-auto px-6 w-full relative z-20 flex flex-col justify-center h-full">
              ...
              >
                ...
                <h1 className="text-5xl lg:text-7xl font-display font-black text-white leading-[0.9] mb-6">
              ...
              >
                ...
                <div className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-display font-black text-[#216581] uppercase">
                    ...
                    {destacados.map((prod, i) => (
                      <div key={i} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                        ...
                        <div className="text-right">
                          <p className="text-lg font-black text-[#216581]">{prod.price}</p>
                        </div>
                      </div>
                    ))}
                  </div>
      ...
      {/* --- SECCIONES HIJAS (DENTRO DE LA MISMA CARPETA) --- */}
      <BestSellers />
      <NewArrivals />
      <ProductReels />
      <Sponsors />
